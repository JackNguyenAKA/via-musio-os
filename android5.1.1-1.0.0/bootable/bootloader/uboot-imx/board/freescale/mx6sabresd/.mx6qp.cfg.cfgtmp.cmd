cmd_board/freescale/mx6sabresd/mx6qp.cfg.cfgtmp := /home/susan/via_Musio-OS/android5.1.1-1.0.0/prebuilts/gcc/linux-x86/arm/arm-eabi-4.6/bin/arm-eabi-gcc -E -Wp,-MD,board/freescale/mx6sabresd/.mx6qp.cfg.cfgtmp.d  -nostdinc -isystem /home/susan/via_Musio-OS/android5.1.1-1.0.0/prebuilts/gcc/linux-x86/arm/arm-eabi-4.6/bin/../lib/gcc/arm-eabi/4.6.x-google/include -Iinclude  -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x17800000    -D__ARM__ -marm -mno-thumb-interwork  -mabi=aapcs-linux  -mword-relocations   -ffunction-sections -fdata-sections -fno-common -ffixed-r9  -msoft-float  -pipe  -march=armv7-a     -x c -o board/freescale/mx6sabresd/mx6qp.cfg.cfgtmp board/freescale/mx6sabresd/mx6qp.cfg

source_board/freescale/mx6sabresd/mx6qp.cfg.cfgtmp := board/freescale/mx6sabresd/mx6qp.cfg

deps_board/freescale/mx6sabresd/mx6qp.cfg.cfgtmp := \
...
board/freescale/mx6sabresd/mx6qp.cfg.cfgtmp: $(deps_board/freescale/mx6sabresd/mx6qp.cfg.cfgtmp)
