cmd_lib/libfdt/fdt_addresses.o := /home/susan/via_Musio-OS/android5.1.1-1.0.0/prebuilts/gcc/linux-x86/arm/arm-eabi-4.6/bin/arm-eabi-gcc -Wp,-MD,lib/libfdt/.fdt_addresses.o.d  -nostdinc -isystem /home/susan/via_Musio-OS/android5.1.1-1.0.0/prebuilts/gcc/linux-x86/arm/arm-eabi-4.6/bin/../lib/gcc/arm-eabi/4.6.x-google/include -Iinclude  -I./arch/arm/include -include ./include/linux/kconfig.h -D__KERNEL__ -D__UBOOT__ -DCONFIG_SYS_TEXT_BASE=0x17800000 -Wall -Wstrict-prototypes -Wno-format-security -fno-builtin -ffreestanding -Os -fno-stack-protector -g -fstack-usage -Wno-format-nonliteral -D__ARM__ -marm -mno-thumb-interwork -mabi=aapcs-linux -mword-relocations -ffunction-sections -fdata-sections -fno-common -ffixed-r9 -msoft-float -pipe -march=armv7-a    -D"KBUILD_STR(s)=\#s" -D"KBUILD_BASENAME=KBUILD_STR(fdt_addresses)"  -D"KBUILD_MODNAME=KBUILD_STR(fdt_addresses)" -c -o lib/libfdt/fdt_addresses.o lib/libfdt/fdt_addresses.c
...
deps_lib/libfdt/fdt_addresses.o := \
  ...
  /home/susan/via_Musio-OS/android5.1.1-1.0.0/prebuilts/gcc/linux-x86/arm/arm-eabi-4.6/bin/../lib/gcc/arm-eabi/4.6.x-google/include/stddef.h \
  ...
  include/configs/mx6sabreandroid_common.h \
    ...
    $(wildcard include/config/fastboot/storage/sata.h) \
    $(wildcard include/config/fastboot/storage/mmc.h) \
    $(wildcard include/config/android/main/mmc/bus.h) \
    $(wildcard include/config/android/boot/partition/mmc.h) \
    $(wildcard include/config/android/system/partition/mmc.h) \
    $(wildcard include/config/android/recovery/partition/mmc.h) \
    $(wildcard include/config/android/cache/partition/mmc.h) \
    $(wildcard include/config/android/data/partition/mmc.h) \
