...
echo "mkpart primary 72 94"     >> $cmdfile
echo "mkpart extended 94 3183"  >> $cmdfile
echo "mkpart primary 3183 -1"   >> $cmdfile
echo "mkpart logical 95 2655"    >> $cmdfile
echo "mkpart logical 2655 3167"  >> $cmdfile
echo "mkpart logical 3167 3175" >> $cmdfile
echo "mkpart logical 3175 3181" >> $cmdfile
echo "mkpart logical 3181 3183" >> $cmdfile
echo "print"                    >> $cmdfile
echo "quit"                     >> $cmdfile
