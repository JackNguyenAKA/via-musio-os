...
class AdvertiseManager {
    ...
    private class AdvertiseNative {
        ...
        boolean startMultiAdvertising(AdvertiseClient client) {
            ...
            resetCountDownLatch();
            //modify by iris 0405 for Gatt Server Adv
            ...
            //Added by lamparten 0316 for Gatt Server Adv
            if (client.scanResponse != null) {
                logd("iris setAdvertisingData setAdvertisingData(client, client.scanResponse, true)");
                setAdvertisingData(client, client.scanResponse, true);
            }
            //Added by lamparten 0316 for Gatt Server Adv
            //add by iris 0405 for Gatt Server Adv
            enableAdvertising(client);
            if (!waitForCallback()) {
                return false;
            }
