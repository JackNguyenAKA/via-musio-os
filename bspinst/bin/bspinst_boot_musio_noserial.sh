...
echo "mkpart primary 72 136"     >> $cmdfile # 2 recovery
echo "mkpart extended 136 3737"  >> $cmdfile #3 
echo "mkpart primary 3737 -1"   >> $cmdfile # 4 data
echo "mkpart logical 137 3209"    >> $cmdfile # 5 system . first of extended 3gb
echo "mkpart logical 3209 3721"  >> $cmdfile # 6,cache 512mb
echo "mkpart logical 3721 3729" >> $cmdfile # 7, device 8mb
echo "mkpart logical 3729 3735" >> $cmdfile # 8, misc 6mb
echo "mkpart logical 3735 3737" >> $cmdfile # 9, datafooter 2mb
echo "print"                    >> $cmdfile
echo "quit"                     >> $cmdfile
