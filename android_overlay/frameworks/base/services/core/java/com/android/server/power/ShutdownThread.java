...
//        pd.show();
    ...
    private static class MusioPowerOffProgressDialog extends Dialog {
        private MusioPowerOffProgressDialog(Context context) {
            super(context);
            requestWindowFeature(Window.FEATURE_NO_TITLE);
            setContentView(R.layout.musio_power_off_prog_dialog);
        }
    }
}
