...
#define CONFIG_IMX_VIDEO_SKIP
	...
	#define DISPLAY_HSYNC_START	32
	#define DISPLAY_HSYNC_END	24
	#define DISPLAY_HSYNC_WIDTH	8

	#define DISPLAY_VSYNC_START	16
	#define DISPLAY_VSYNC_END	24
...
#if defined(CONFIG_SABRELITE) && !defined(CONFIG_SYS_USE_SPINOR)
