...
TARGET_RECOVERY_FSTAB = device/fsl/musio/fstab_sd.freescale
# build for ext4
PRODUCT_COPY_FILES +=	\
	device/fsl/musio/fstab_sd.freescale:root/fstab.freescale
else
TARGET_RECOVERY_FSTAB = device/fsl/musio/fstab_sd-f2fs.freescale
# build for f2fs
PRODUCT_COPY_FILES +=	\
	device/fsl/musio/fstab_sd-f2fs.freescale:root/fstab.freescale
endif # BUILD_TARGET_FS
else
ADDITIONAL_BUILD_PROPERTIES += \
                        ro.boot.storage_type=emmc
ifneq ($(BUILD_TARGET_FS),f2fs)
TARGET_RECOVERY_FSTAB = device/fsl/musio/fstab.freescale
# build for ext4
PRODUCT_COPY_FILES +=	\
	device/fsl/musio/fstab.freescale:root/fstab.freescale
else
TARGET_RECOVERY_FSTAB = device/fsl/musio/fstab-f2fs.freescale
# build for f2fs
PRODUCT_COPY_FILES +=	\
	device/fsl/musio/fstab-f2fs.freescale:root/fstab.freescale
endif # BUILD_TARGET_FS
...
UBI_ROOT_INI := device/fsl/musio/ubi/ubinize.ini
...
BOARD_BLUETOOTH_BDROID_BUILDCFG_INCLUDE_DIR := device/fsl/musio/bluetooth
